...
class CheckSuite(unittest.TestCase):
    ...
    def test_method_redeclered_param_block(self):
        """
        class Program {func @main() {}}
        Class a {
        ...
        input = Program([ClassDecl(Id("Program"),[MethodDecl(Id("@main"),[],VoidType(),Block([]))])
                         ,ClassDecl(Id('a'),[MethodDecl(Id("a"),
    ...
    def test_if_redeclered_prestmt(self):
        ...
        input = Program([ClassDecl(Id('Program'),[MethodDecl(Id("@main"),
                                                             [],
                                                             VoidType(),
                                                             Block([If(BinaryOp("<",Id("a"),IntLiteral(0)),Block([VarDecl(Id("a"),IntType())]),Block([ConstDecl(Id("a"),IntType(),IntLiteral(10))]))]))])])
        expect = "Redeclared Attribute: a"

...
class CheckSuite(unittest.TestCase):
    ...
    def test_if_redeclered(self):
        ...
        input = Program([ClassDecl(Id('Program'),[MethodDecl(Id("@main"),
                                                             [],
                                                             VoidType(),
                                                             Block([If(BinaryOp("<",IntLiteral('5'),IntLiteral(0)),
                                                                       Block([VarDecl(Id("a"),IntType()),
    ...
    def test_if_redeclered_elseStmt(self):
        ...
        input = Program([ClassDecl(Id('Program'),[MethodDecl(Id("@main"),
                                                             [],
                                                             VoidType(),
                                                             Block([If(BinaryOp("<",IntLiteral(5),IntLiteral(0)),Block([VarDecl(Id("a"),IntType())]),None,Block([VarDecl(Id("b"),IntType()),ConstDecl(Id("b"),IntType(),None)]))]))])])
    ...
    def test_if_in_if(self):  
        ...
        input = Program([ClassDecl(Id('a'),[]),
                         ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([
                             If(BinaryOp("<",FloatLiteral(1.2),IntLiteral(5)),Block([
                                 VarDecl(Id("a"),IntType()),
...
## for for break/con
            ...
            ClassDecl(Id("C"),[MethodDecl(Id('constructor'),[],VoidType(),Block([])),
                               ...
                               MethodDecl(Id("@a"),[VarDecl(Id("a"),IntType())],IntType(),
                                          Block([ConstDecl(Id('b'),BoolType(),BooleanLiteral(True)),
                                                 VarDecl(Id('a'),ClassType(Id('C')),NewExpr(Id('C'),[])),
                                                 VarDecl(Id('z'),ClassType(Id('C')),NewExpr(Id('C'),[IntLiteral(1),Id('a')])),
                                                 CallStmt(SelfLiteral(),Id('sikma'),[IntLiteral(1),StringLiteral('a'),Id('b')])]))]),
            ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([]))],Id("C"))])
        expect = "[]"
        self.assertTrue(TestChecker.test(input,expect,482))  
    
    def test_call_stmt_wrong_param(self):  
        """ 
        class C {
            func constructor() {}
            func constructor(a:int ,b : C) {}
            ...
            ClassDecl(Id("C"),[MethodDecl(Id('constructor'),[],VoidType(),Block([])),
                               ...
                               MethodDecl(Id("@a"),[VarDecl(Id("a"),IntType())],IntType(),
                                          Block([ConstDecl(Id('b'),BoolType(),BooleanLiteral(True)),
                                                 VarDecl(Id('a'),ClassType(Id('C')),NewExpr(Id('C'),[])),
                                                 VarDecl(Id('z'),ClassType(Id('C')),NewExpr(Id('C'),[IntLiteral(1),Id('a')])),
                                                 CallStmt(SelfLiteral(),Id('sikma'),[IntLiteral(1),Id('a'),Id('b')])]))]),
            ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([]))],Id("C"))])
        expect = "Type Mismatch In Statement: Call(Self(),Id(sikma),[IntLit(1),Id(a),Id(b)])"
        self.assertTrue(TestChecker.test(input,expect,483))  
    
    def test_call_stmt_non_void_type(self):  
        """ 
        class C {
            func constructor() {}
            func constructor(a:int ,b : C) {}
            const a : int = 1 ;
            func sikma(a:int,b:string,c:bool):string {}
            func @a(a : int) : int{
                const b : bool = true;
                var a : C = new C();
                var z : C = new C(1, a);
        ...
        input = Program([                                                                                                                 
            ClassDecl(Id("C"),[MethodDecl(Id('constructor'),[],VoidType(),Block([])),
                               ...
                               MethodDecl(Id('sikma'),[VarDecl(Id('a'),IntType()),
                                                       VarDecl(Id('b'),StringType()),
                                                       VarDecl(Id('c'),BoolType())],StringType(),Block([])),
                               MethodDecl(Id("@a"),[VarDecl(Id("a"),IntType())],IntType(),
                                          Block([ConstDecl(Id('b'),BoolType(),BooleanLiteral(True)),
                                                 VarDecl(Id('a'),ClassType(Id('C')),NewExpr(Id('C'),[])),
                                                 VarDecl(Id('z'),ClassType(Id('C')),NewExpr(Id('C'),[IntLiteral(1),Id('a')])),
                                                 CallStmt(SelfLiteral(),Id('sikma'),[IntLiteral(1),StringLiteral('a'),Id('b')])]))]),
            ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([]))],Id("C"))])
        expect = "Type Mismatch In Statement: Call(Self(),Id(sikma),[IntLit(1),StringLit(a),Id(b)])"
        self.assertTrue(TestChecker.test(input,expect,484))      
    
    def test_call_stmt_io_read(self):  
        """ 
        class C {
            func constructor() {}
            func constructor(a:int ,b : C) {}
            ...
            ClassDecl(Id("C"),[MethodDecl(Id('constructor'),[],VoidType(),Block([])),
                               ...
                               MethodDecl(Id("@a"),[VarDecl(Id("a"),IntType())],IntType(),
                                          Block([ConstDecl(Id('b'),BoolType(),BooleanLiteral(True)),
                                                 ...
                                                 VarDecl(Id('z'),ClassType(Id('C')),NewExpr(Id('C'),[IntLiteral(1),Id('a')])),
                                                 CallStmt(SelfLiteral(),Id('sikma'),[IntLiteral(1),StringLiteral('a'),Id('b')]),
                                                 CallStmt(Id('io'),Id('@readStr'),[])]))]),
            ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([]))],Id("C"))])
        expect = "Type Mismatch In Statement: Call(Id(io),Id(@readStr),[])"
        self.assertTrue(TestChecker.test(input,expect,485))  

    def test_call_stmt_io_write_wrong_param(self):  
        """ 
        class C {
            func constructor() {}
            func constructor(a:int ,b : C) {}
            ...
            ClassDecl(Id("C"),[MethodDecl(Id('constructor'),[],VoidType(),Block([])),
                               ...
                               MethodDecl(Id("@a"),[VarDecl(Id("a"),IntType())],IntType(),
                                          Block([ConstDecl(Id('b'),BoolType(),BooleanLiteral(True)),
                                                 ...
                                                 VarDecl(Id('z'),ClassType(Id('C')),NewExpr(Id('C'),[IntLiteral(1),Id('a')])),
                                                 CallStmt(SelfLiteral(),Id('sikma'),[IntLiteral(1),StringLiteral('a'),Id('b')]),
                                                 CallStmt(Id('io'),Id('@writeStr'),[Id('b')])]))]),
            ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([]))],Id("C"))])
        expect = "Type Mismatch In Statement: Call(Id(io),Id(@writeStr),[Id(b)])"
        self.assertTrue(TestChecker.test(input,expect,486)) 

    def test_call_stmt_io_write(self):  
        """ 
        class C {
            func constructor() {}
            func constructor(a:int ,b : C) {}
            ...
            ClassDecl(Id("C"),[MethodDecl(Id('constructor'),[],VoidType(),Block([])),
                               ...
                               MethodDecl(Id("@a"),[VarDecl(Id("a"),IntType())],IntType(),
                                          Block([ConstDecl(Id('b'),BoolType(),BooleanLiteral(True)),
                                                 ...
                                                 VarDecl(Id('z'),ClassType(Id('C')),NewExpr(Id('C'),[IntLiteral(1),Id('a')])),
                                                 CallStmt(SelfLiteral(),Id('sikma'),[IntLiteral(1),StringLiteral('a'),Id('b')]),
                                                 CallStmt(Id('io'),Id('@writeStr'),[StringLiteral('b')])]))]),
            ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([]))],Id("C"))])
        expect = "[]"
        self.assertTrue(TestChecker.test(input,expect,487)) 

    def test_For_Arraycell_undecl(self):  
        """ 
        class C {
            const a : int = 1 ;
            func @a(a : int) : int{
            ...
            ClassDecl(Id("C"),[ConstDecl(Id("a"),IntType(),IntLiteral(1)),
                               MethodDecl(Id("@a"),[VarDecl(Id("a"),IntType())],IntType(),
                                          Block([VarDecl(Id('b'),FloatType()),
                                                 Assign(Id('b'),BinaryOp('*',BinaryOp('+',Id('a'),BinaryOp('+',IntLiteral(1),IntLiteral(3))),
                                                                         FloatLiteral(1.2))),
                                                 For(Assign(ArrayCell(Id('c'),IntLiteral(1)), IntLiteral(0)), 
                                                     BinaryOp('<',ArrayCell(Id('c'),IntLiteral(2)),IntLiteral(1)),
                                                     Assign(ArrayCell(Id('c'),IntLiteral(2)), 
                                                            BinaryOp('+',ArrayCell(Id('c'),IntLiteral(1)),IntLiteral(1))),Block([]))]))]),
            ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([]))],Id("C"))])
        expect = "Undeclared Attribute: c"
        self.assertTrue(TestChecker.test(input,expect,488))

    def test_For_Arraycell_wrong_type(self):  
        """ 
        class C {
            const a : int = 1 ;
            func @a(a : int) : int{
                                          ...
                                          Block([VarDecl(Id('b'),FloatType()),
                                                 ...
                                                 For(Assign(ArrayCell(Id('c'),IntLiteral(1)), IntLiteral(0)), 
                                                     ...
                                                     Assign(ArrayCell(Id('c'),IntLiteral(2)), 
                                                            BinaryOp('+',ArrayCell(Id('c'),IntLiteral(1)),IntLiteral(1))),Block([]))]))]),
            ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([]))],Id("C"))])
        expect = "Type Mismatch In Expression: ArrayCell(Id(c),IntLit(1))"
        self.assertTrue(TestChecker.test(input,expect,489))

    def test_For_Arraycell(self):  
        """ 
        class C {
            const a : int = 1 ;
            func @a(a : int) : int{
    ...
    def test_For_Arraycell_type(self):  
        """ 
        class C {
            const a : int = 1 ;
            func @a(a : int) : int{
            ...
            ClassDecl(Id("C"),[ConstDecl(Id("a"),IntType(),IntLiteral(1)),
                               MethodDecl(Id("@a"),[VarDecl(Id("a"),IntType())],IntType(),
                                          Block([VarDecl(Id('b'),FloatType()),
                                                 Assign(Id('b'),BinaryOp('*',BinaryOp('+',Id('a'),BinaryOp('+',IntLiteral(1),IntLiteral(3))),
                                                                         FloatLiteral(1.2))),
                                                 VarDecl(Id('c'),ArrayType(5,StringType())),
                                                 For(Assign(ArrayCell(Id('c'),IntLiteral(1)), IntLiteral(0)), 
                                                     BinaryOp('<',ArrayCell(Id('c'),IntLiteral(2)),IntLiteral(1)),
                                                     Assign(ArrayCell(Id('c'),IntLiteral(2)), 
                                                            BinaryOp('+',ArrayCell(Id('c'),IntLiteral(1)),IntLiteral(1))),Block([]))]))]),
            ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([]))],Id("C"))])
        expect = "Type Mismatch In Statement: AssignStmt(ArrayCell(Id(c),IntLit(1)),IntLit(0))"
        self.assertTrue(TestChecker.test(input,expect,491))
        
    def test_For_Arraycell_const(self):  
        """ 
        class C {
            const a : int = 1 ;
            func @a(a : int) : int{
            ...
            ClassDecl(Id("C"),[ConstDecl(Id("a"),IntType(),IntLiteral(1)),
                               MethodDecl(Id("@a"),[VarDecl(Id("a"),IntType())],IntType(),
                                          Block([VarDecl(Id('b'),FloatType()),
                                                 Assign(Id('b'),BinaryOp('*',BinaryOp('+',Id('a'),BinaryOp('+',IntLiteral(1),IntLiteral(3))),
                                                                         FloatLiteral(1.2))),
                                                 ConstDecl(Id('c'),ArrayType(5,IntType()),ArrayLiteral([IntLiteral(1),IntLiteral(5),IntLiteral(3),IntLiteral(5),IntLiteral(4)])),
                                                 For(Assign(ArrayCell(Id('c'),IntLiteral(1)), IntLiteral(0)), 
                                                     BinaryOp('<',ArrayCell(Id('c'),IntLiteral(2)),IntLiteral(1)),
                                                     Assign(ArrayCell(Id('c'),IntLiteral(2)), 
                                                            BinaryOp('+',ArrayCell(Id('c'),IntLiteral(1)),IntLiteral(1))),Block([]))]))]),
            ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([]))],Id("C"))])
        expect = "Cannot Assign To Constant: AssignStmt(ArrayCell(Id(c),IntLit(1)),IntLit(0))"
        self.assertTrue(TestChecker.test(input,expect,492))

    def test_For_Field_Access_const(self):  
        """ 
        class C {
            const a : int = 1 ;
            func @a(a : int) : int{
            ...
            ClassDecl(Id("C"),[ConstDecl(Id("a"),IntType(),IntLiteral(1)),
                               MethodDecl(Id("@a"),[VarDecl(Id("a"),IntType())],IntType(),
                                          Block([VarDecl(Id('b'),FloatType()),
                                                 Assign(Id('b'),BinaryOp('*',BinaryOp('+',Id('a'),BinaryOp('+',IntLiteral(1),IntLiteral(3))),
                                                                         FloatLiteral(1.2))),
                                                 VarDecl(Id('c'),ClassType(Id('C'))),
                                                 For(Assign(FieldAccess(Id('c'),Id('a')),IntLiteral(0)), 
                                                     BinaryOp('<',FieldAccess(Id('c'),Id('a')),IntLiteral(1)),
                                                     Assign(FieldAccess(Id('c'),Id('a')), 
                                                            BinaryOp('+',ArrayCell(Id('c'),IntLiteral(1)),IntLiteral(1))),
                                                     Block([]))]))]),
            ClassDecl(Id('Program'),[MethodDecl(Id("@main"),[],VoidType(),Block([]))],Id("C"))])
        expect = "Cannot Assign To Constant: AssignStmt(FieldAccess(Id(c),Id(a)),IntLit(0))"
        self.assertTrue(TestChecker.test(input,expect,493))

    def test_For_Field_Access(self):  
        """ 
        class C {
            var a : int = 1 ;
            func @a(a : int) : int{
        ...
        """
        input = Program([                                                                                                                 
            ClassDecl(Id("C"),[VarDecl(Id("a"),IntType(),IntLiteral(1)),
                               MethodDecl(Id("@a"),[VarDecl(Id("a"),IntType())],IntType(),
                                          Block([VarDecl(Id('b'),FloatType()),
                                                 Assign(Id('b'),BinaryOp('*',BinaryOp('+',Id('a'),BinaryOp('+',IntLiteral(1),IntLiteral(3))),
                                                                         FloatLiteral(1.2))),
